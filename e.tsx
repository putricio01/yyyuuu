...
// Dynamic background pattern: grid lines shift with volume peaks
	...
	ctx.save();
	ctx.globalAlpha = 0.6;
	ctx.fillStyle = ZESTY_COLORS.accent;
  ...
  useEffect(() => {
	...
	return () => {
	  ...
	  return (
			<main className="h-screen bg-[linear-gradient(to_top,_black,_#c7e959_100%,_#c7e959)] w-full flex items-center justify-center p-6 relative overflow-hidden">
			  {showIntro && (
					<div
					  onTransitionEnd={() => {
							if (introAnim) setShowIntro(false);
					  }}
					  className={`fixed inset-0 z-50 flex items-center justify-center bg-black text-white transition-opacity duration-700 ${introAnim ? "opacity-0" : "opacity-100"}`}
					>
					  <div className={`text-center transition-transform duration-700 ${introAnim ? "-translate-x-full" : "translate-x-0"}`}>
							...
							<button
							  ...
							  className="mt-6 cursor-pointer hover:opacity-70 active:opacity-70 transition bg-[#c7e959] p-3 px-6 rounded text-[#06080a] font-normal"
							>
							  Start
							</button>
					  </div>
	  ...
	  <div className="lg:w-[27%] p-2 sm:p-4 text-white flex flex-col justify-center lg:max-w-[27%] mx-auto overflow-auto">
					  <div className="my-4 space-y-3 w-full">
					   <h1 className="text-[1.4rem] leading-[1.4rem] font-semibold sm:text-[1.74rem] sm:leading-[1.74rem]">
			  Generate <br /> geometric,{" "}
			  <span className="text-[#c7e959]">lemon-zest</span>{" "}
			  <span className="text-white/70">visualizations </span>
			</h1>
		  ...
		  <div className="mt-4">
			<button
			  ...
			  className="cursor-pointer hover:opacity-70 active:opacity-70 transition bg-[#c7e959] p-2 px-4 text-xs sm:p-3 sm:px-6 sm:text-base rounded text-[#06080a] font-normal flex items-center"
	  >
			...
			<button
			  onClick={() => fileInputRef.current?.click()}
			   className="cursor-pointer hover:opacity-70 active:opacity-70 transition bg-[#c7e959] p-2 px-4 text-xs sm:p-3 sm:px-6 sm:text-base rounded text-[#06080a] font-normal flex items-center mt-3"
	   >
	  ...
	  >
		...
		<div
			 ref={containerRef}
							className="w-full lg:w-[73%] bg-[#c7e959]/40 relative min-h-[200px] flex items-center justify-center"
					  >
							  <canvas
															  ref={canvasRef}
													...
													/>
		  <div className="absolute bottom-0 left-0 w-full flex p-3 gap-2 font-normal justify-evenly bg-[linear-gradient(to_top,_#c7e959_0%,_#c7e959_0%,_transparent_120%)] sm:p-6 sm:gap-4">
	<button
			  onClick={handleScreenshot}
			   className="cursor-pointer hover:opacity-70 active:opacity-70 flex text-xs items-center gap-1 sm:text-sm sm:gap-2"
			>
			  <Camera />
			  Screenshot
			</button>
			...
			<button
			  ...
			  onClick={handleEnterPip}
			   className={`hover:opacity-70 active:opacity-70 flex text-xs items-center gap-1 sm:text-sm sm:gap-2 ${
				pipMode ? "text-[#F9F871]" : ""
